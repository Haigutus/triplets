...
# >>> stamps SOURCE_URI / SOURCE_LINE onto every violation —
...
print(located.loc[located["SEVERITY"] == "Violation",
                  ["ID", "OBJECT_TYPE", "OBJECT_NAME", "SOURCE_LINE"]]
...
# >>> results carry file + the whole-line region of the violated element
