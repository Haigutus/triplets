# -------------------------------------------------------------------------------
# Name:        RDF parser - pygixml variant
# Purpose:     Uses pygixml (Cython wrapper around pugixml C++ library)
#              instead of lxml for XML parsing. Claims 15.9x faster than
#              ElementTree, 5.3x faster than lxml.
#
# Based on:    rdf_parser.py by kristjan.vilgo
# Variant:     pygixml XML parser (benchmark variant)
# -------------------------------------------------------------------------------
