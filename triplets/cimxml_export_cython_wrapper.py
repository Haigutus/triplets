"""Python wrapper for Cython CIM XML export.

Handles profile detection and rdf_map loading, then delegates
the heavy lifting to the Cython generate_xml_bytes function.
"""
import json
import uuid
import logging

from triplets.cimxml_export_cython import generate_xml_bytes
...
def generate_xml(instance_data,
                 ...
                 comment=None,
                 debug=False):
    """Generate CIM RDF/XML using Cython string builder."""
