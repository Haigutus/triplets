...
parser = argparse.ArgumentParser(description="""Convert EXCEL representation of RDF data to RDF/XML""",
                                 epilog=f"""Copyright (c): Kristjan Vilgo 2025;
                                           Creator: kristjan.vilgo@gmail.com;
                                           Licence: MIT;
                                           Version: {version}""",
...
parser.add_argument('--triplets_sheet', type=str, help='Name of Excel Sheets containig triplets data to be exported', required=False)
